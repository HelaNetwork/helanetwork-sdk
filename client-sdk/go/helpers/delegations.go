...
func PrettyPrintAccountBalanceAndDelegationsFrom(
	...
	escrowAccount staking.EscrowAccount,
	...
	escrowBalance := escrowAccount.Active.Balance
	...
	fmt.Fprintf(w, "%sEscrow: ", prefix)
	fmt.Fprintf(w, "%s\n", FormatConsensusDenomination(network, escrowBalance))
	fmt.Fprintln(w)
